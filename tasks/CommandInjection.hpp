...
#ifndef AUV_CONTROL_COMMANDINJECTION_TASK_HPP
#define AUV_CONTROL_COMMANDINJECTION_TASK_HPP

#include "auv_control/CommandInjectionBase.hpp"
...
namespace auv_control {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','auv_control::CommandInjection')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class CommandInjection : public CommandInjectionBase
    {
