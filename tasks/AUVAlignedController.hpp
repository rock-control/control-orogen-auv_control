...
namespace auv_control {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','auv_control::AUVAlignedController')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for AUVAlignedController
        ...
        /** Default deconstructor of AUVAlignedController
         */
