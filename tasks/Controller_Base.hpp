...
namespace auv_control {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','auv_control::Controller_Base')
     end
     \endverbatim
    ...
    protected:
        ...
        /* Handler for the add_command_input operation
         */
	...
	~Controller_Base();
        ...
        /** This Method benefits the subclasses. It validates the Commands that 
         * are given
         */
