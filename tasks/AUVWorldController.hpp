...
namespace auv_control {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','auv_control::AUVWorldController')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for AUVWorldController
        ...
        /** Default deconstructor of AUVWorldController
         */
	~AUVWorldController();
